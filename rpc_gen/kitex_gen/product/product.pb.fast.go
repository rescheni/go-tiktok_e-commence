...
func (x *Product) fastReadField6(buf []byte, _type int8) (offset int, err error) {
	...
	x.Categorys = append(x.Categorys, v)
	return offset, err
}
...
func (x *ListProductResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
...
func (x *SearchProductResp) fastReadField2(buf []byte, _type int8) (offset int, err error) {
	x.Total, offset, err = fastpb.ReadInt32(buf, _type)
	return offset, err
}
...
func (x *Product) fastWriteField6(buf []byte) (offset int) {
	if len(x.Categorys) == 0 {
		return offset
	}
	for i := range x.GetCategorys() {
		offset += fastpb.WriteString(buf[offset:], 6, x.GetCategorys()[i])
	}
	return offset
}
...
func (x *ListProductResp) fastWriteField2(buf []byte) (offset int) {
	if x.Total == 0 {
		return offset
	}
...
func (x *SearchProductResp) fastWriteField2(buf []byte) (offset int) {
	if x.Total == 0 {
		return offset
	}
	offset += fastpb.WriteInt32(buf[offset:], 2, x.GetTotal())
...
func (x *Product) sizeField6() (n int) {
	...
	for i := range x.GetCategorys() {
		n += fastpb.SizeString(6, x.GetCategorys()[i])
	}
	return n
}
...
func (x *ListProductResp) sizeField2() (n int) {
	if x.Total == 0 {
		return n
	}
...
func (x *SearchProductResp) sizeField2() (n int) {
	if x.Total == 0 {
		return n
	}
	n += fastpb.SizeInt32(2, x.GetTotal())
