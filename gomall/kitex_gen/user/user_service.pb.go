...
func (x *UserCreateResp) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *UserCreateResp) GetErr() string {
	if x != nil {
		return x.Err
	}
	return ""
...
var file_user_user_service_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22,
	...
	0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x38,
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x72, 0x72, 0x32, 0x46, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72,
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x37, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x13, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x14, 0x2e, 0x75, 0x73, 0x65,
	0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x42, 0x22, 0x5a, 0x20, 0x65, 0x2d, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x63, 0x65, 0x2f, 0x67,
	0x6f, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x6b, 0x69, 0x74, 0x65, 0x78, 0x5f, 0x67, 0x65, 0x6e, 0x2f,
...
var file_user_user_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_user_user_service_proto_goTypes = []interface{}{
	(*UserCreateReq)(nil),  // 0: user.UserCreateReq
	(*UserCreateResp)(nil), // 1: user.UserCreateResp
}
var file_user_user_service_proto_depIdxs = []int32{
	0, // 0: user.UserService.UserCreate:input_type -> user.UserCreateReq
	1, // 1: user.UserService.UserCreate:output_type -> user.UserCreateResp
...
type UserService interface {
	UserCreate(ctx context.Context, req *UserCreateReq) (res *UserCreateResp, err error)
}
